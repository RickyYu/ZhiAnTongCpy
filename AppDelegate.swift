...
class AppDelegate: UIResponder, UIApplicationDelegate,BMKGeneralDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let ret = _mapManager?.start("93PSuGEjo7PgZg01YDnG7coo9vlPoAFd", generalDelegate: self)
        if ret == false {
    ...
    func OYLog<T>(message: T, fileName: String = #file, lineNum: Int = #line, funcName: String = #function)
    {
        #if DEBUG
